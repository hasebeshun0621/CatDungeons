...
float TutWalkTop = 100.0f;
float TutWalkHeigt = 400.0f;
float TutWalkSide = SCREEN_WIDTH - 200.0f;
float TutWalkWidth = SCREEN_WIDTH - 10.0f;
...
void UpdateTutorialWalk() {

}

void DrawTutorialWalk() {
	// シェーダーをGPUにセット
	g_shader.SetGPU();
	...
	vertex[0].Position = Vector3(TutWalkSide, TutWalkTop, 0.0f);
	vertex[0].Normal = Vector3(0.0f, 1.0f, 0.0f);
	vertex[0].Diffuse = Vector4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[0].TexCoord = Vector2(0.0f, 0.0f);

	vertex[1].Position = Vector3(TutWalkWidth, TutWalkTop, 0.0f);
	vertex[1].Normal = Vector3(0.0f, 1.0f, 0.0f);
	vertex[1].Diffuse = Vector4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = Vector2(1.0f, 0.0f);

	vertex[2].Position = Vector3(TutWalkSide, TutWalkHeigt, 0.0f);
	vertex[2].Normal = Vector3(0.0f, 1.0f, 0.0f);
	vertex[2].Diffuse = Vector4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = Vector2(0.0f, 1.0f);

	vertex[3].Position = Vector3(TutWalkWidth, TutWalkHeigt, 0.0f);
	vertex[3].Normal = Vector3(0.0f, 1.0f, 0.0f);
	vertex[3].Diffuse = Vector4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[3].TexCoord = Vector2(1.0f, 1.0f);
